...
import { SIA_AUDIT_TRAIL } from "./siaExpertData";
import { ArrowLeft, Shield, Clock } from "lucide-react";

export default function SiaAuditTrailPage() {
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-[#0F2340]">SIA Audit Trail</h1>
        <p className="text-sm text-muted-foreground mt-1">{SIA_AUDIT_TRAIL.length} audit entries recorded</p>
      </div>

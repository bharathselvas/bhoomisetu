...
import { SIA_NOTIFICATIONS } from "./siaExpertData";
...
export default function SiaNotificationsPage() {
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground mt-1">{SIA_NOTIFICATIONS.filter((n) => !n.read).length} unread</p>
      </div>

      <div className="space-y-3">
        {SIA_NOTIFICATIONS.map((n) => {

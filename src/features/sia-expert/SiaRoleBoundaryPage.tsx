...
import { ArrowLeft, Shield, CheckCircle2, XCircle, Lock } from "lucide-react";

const CAN_DO = [
  "Conduct Social Impact Assessment",
  "Record affected families",
  "Conduct Gram Sabha consultations",
  "Record public/stakeholder consultations",
  "Assess social & livelihood impacts",
  "Upload/attach evidence",
  "Prepare SIA findings",
  "Prepare SIA report",
  "Submit assessment",
...
const CANNOT_DO = [
  "Issue Section 11 Preliminary Notification",
  "Decide land acquisition objections",
...
const REQUIRED_ROLES: Record<string, string> = {
  "Issue Section 11 Preliminary Notification": "District Collector / CALA",
  "Decide land acquisition objections": "District Collector / CALA",
  "Approve compensation": "District Collector / CALA",
  "Finalize award": "District Collector / CALA",
  "Authorize statutory possession": "District Collector / CALA",
};

export default function SiaRoleBoundaryPage() {
  return (
      ...
      <Card className="mb-6 border-blue-200 bg-blue-50">
        <CardContent className="p-5">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h2 className="text-lg font-bold text-[#0F2340]">SIA Expert Group</h2>
              <p className="text-sm text-muted-foreground">Independent expert assessment role</p>
            </div>
          </div>
        </CardContent>
      </Card>
